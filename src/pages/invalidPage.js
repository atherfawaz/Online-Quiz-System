                ...
                <div class="page-404">
                    <div class="container">
                        ...
                        <div class="error-text">
                            <p>Page doesn’t exist or some other error occured. Go to our <a href="index.html">home page</a> or go to back previous page</p>
                        </div>
                    </div>
                </div>
                <footer id="footer">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <div class="contact-view">
                                        <div class="contact-slide">
                                            <p><i class="fa fa-location-arrow"></i>76 Woodland Ave. Sherman Drive  <br />Fort Walton Beach,Harlingen</p></div>
                                            <div class="contact-slide">

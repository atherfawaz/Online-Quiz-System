      ...
      <div>
        <section className="banner inner-page">
          <div className="banner-img">
            <img src="images/banner/account-settings.jpg" alt="" />
          </div>
              ...
              <div className="tab-content profile-con open">
                ...
                <div className="personal-information">
                  <div className="info-slide">
                    <p>
                      <span>Name :</span>Stefan Hartmann
                    </p>
                  </div>
                  <div className="info-slide">
                    <p>
                      <span>Email ID :</span>StefanHartmann@jourrapide.com
                    </p>
                  </div>
                  <div className="info-slide">
                    <p>
                      <span>Mobile Number :</span>02692 83 14 96
                    </p>
                  </div>
                  <div className="info-slide">
                    <p>
                      <span>Date Of Birth :</span>June 6, 1987
                    </p>
                  </div>
                  <div className="info-slide">
                    <p>
              ...
              <div className="tab-content order-con">
                <table className="booking-viewTable">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <span className="small-heading">Courses ID</span>
                        258452112500
                      </td>
                      <td className="detail">
                        ...
                        <div className="detailTd">
                          ...
                          <p>
                            Behind Shalby Hospital, Garden Road, Prahlad Nagar ,
                            Ahmedabad-380015
                          </p>
                        </div>
                      </td>
                      <td>
                        <span className="small-heading">Purchase Date</span>25
                        <sup>th</sup> Aug 2015
                      </td>
                      <td>
                        <span className="small-heading">Amount</span>Rs. 42,710
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="row">
                <div className="col-sm-6 col-md-3">
                  ...
                  <div className="course-slide">
                    ...
                    <p>
                      <a href="/">when an unknown printer took </a>
                    </p>
                ...
                <div className="col-sm-6 col-md-3">
                  ...
                  <div className="contact-view">
                    <div className="contact-slide">
                      <p>
                        <i className="fa fa-location-arrow"></i>76 Woodland Ave.
                        Sherman Drive <br />
                    ...
                    <div className="contact-slide">
                      <p>
                        <i className="fa fa-phone"></i>+299 97 39 82
                      </p>
                    </div>
                    <div className="contact-slide">
                      <p>
                        <i className="fa fa-fax"></i>(08) 8971 7450
                      </p>
                    </div>
                    <div className="contact-slide">
                      <p>
